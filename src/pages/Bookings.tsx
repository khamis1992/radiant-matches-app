            ...
            <div className="space-y-4">
              {upcoming.map((booking) => (
                <Link key={booking.id} to={`/bookings/${booking.id}`}>
                  <div className="bg-card rounded-2xl border border-border p-4 shadow-sm hover:border-primary/50 transition-colors">
        ...
        <section>
          ...
          {past.length > 0 ? (
            <div className="space-y-4">
              {past.map((booking) => (
                <Link key={booking.id} to={`/bookings/${booking.id}`}>
                  <div className="bg-card rounded-2xl border border-border p-4 shadow-sm opacity-80 hover:border-primary/50 transition-colors">
                    <div className="flex items-start gap-3">
                      <img
                        src={booking.artist?.profile?.avatar_url || artist1}
                        alt={booking.artist?.profile?.full_name || "Artist"}
