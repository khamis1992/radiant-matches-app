...
export const ar = {
  ...
  checkout: {
    ...
    secureOnlinePayment: "دفع إلكتروني آمن",
    cashOnDelivery: "الدفع عند الاستلام",
    payWhenYouReceive: "ادفعي عند الاستلام",
    sadadRedirectNote: "سيتم تحويلك إلى بوابة سداد الآمنة لإتمام عملية الدفع.",
    processing: "جارٍ المعالجة...",
    placeOrder: "تأكيد الطلب",
    termsNote: "بتأكيدك هذا الطلب، أنتِ توافقين على شروط الخدمة",
    cartEmpty: "سلتك فارغة",
    fillRequired: "يرجى تعبئة جميع حقول الشحن المطلوبة",
    invalidPhone: "يرجى إدخال رقم هاتف صحيح",
    locationDetected: "تم تحديد الموقع بنجاح!",
    locationFailed: "تعذر الحصول على تفاصيل العنوان. يرجى الإدخال يدوياً.",
    geoUnsupported: "المتصفح لا يدعم تحديد الموقع",
    locationDenied: "تم رفض إذن الموقع. يرجى تفعيل أذونات الموقع.",
    locationUnavailable: "معلومات الموقع غير متاحة.",
    locationTimeout: "انتهت مهلة طلب الموقع. حاولي مرة أخرى.",
    locationError: "حدث خطأ أثناء تحديد الموقع.",
    paymentInitFailed: "فشل بدء عملية الدفع. حاولي مرة أخرى أو استخدمي الدفع عند الاستلام.",
  ...
  orders: {
    ...
    noOrdersDesc: "عند إتمام طلب، سيظهر هنا",
