export const en = {
  ...
  checkout: {
    ...
    sadadRedirectNote: "You will be redirected to Sadad's secure payment gateway to complete your payment.",
    processing: "Processing...",
    placeOrder: "Place Order",
    termsNote: "By placing this order, you agree to our Terms of Service",
    cartEmpty: "Your cart is empty",
    fillRequired: "Please fill in all required shipping fields",
    invalidPhone: "Please enter a valid phone number",
    locationDetected: "Location detected successfully!",
    locationFailed: "Could not get address details. Please enter manually.",
    ...
    paymentInitFailed: "Failed to initiate payment. Please try again or use cash on delivery.",
