export const en = {
  ...
  artistServices: {
    ...
    addFirstService: "Add your first service to start receiving bookings",
    serviceName: "Name",
    serviceNamePlaceholder: "e.g., Bridal Makeup",
  ...
  compare: {
    ...
    shareTitle: "Compare These Artists",
    noArtists: "No Artists to Compare",
    noArtistsDesc: "You haven't selected any artists to compare yet. Browse our talented artists to get started.",
    tooManyArtists: "Too Many Artists",
    tooManyArtistsDesc: "You can compare up to 3 artists at a time. Remove some artists to continue.",
    browseArtists: "Browse Artists",
    ...
    distanceUnknown: "N/A",
    bookNow: "Book Now",
    tipText: "Compare artists based on rating, experience, services offered, and distance to find the perfect match for your needs.",
    shareSuccess: "Comparison link copied to clipboard!",
  ...
  referral: {
    ...
    stats: "Stats",
    history: "History",
    ourReferralLink: "Your Referral Link",
    ...
    howItWorksDesc: "Share your unique referral link with friends. When they sign up and complete their first booking, you earn rewards!",
    noReferralsYet: "No Referrals Yet",
    noReferralsYetDesc: "Start sharing your referral link to earn rewards for every friend who signs up and makes a booking.",
    completed: "Completed",
    pending: "Pending",
    reward: "Reward",
    unknownUser: "Unknown User",
    codeCreated: "Referral code created successfully!",
    codeCreationFailed: "Failed to create referral code",
    copyFailed: "Failed to copy link",
    rewardsProgram: "Rewards Program",
    rewardPerReferral: "Earn per referral:",
    minWithdraw: "Minimum withdrawal:",
    shareAndEarn: "Share & Earn",
    inviteFriends: "Invite Friends",
    shareInSocial: "Share in Social Media",
  },
  ...
  wallet: {
    ...
    requestWithdrawal: "Request Withdrawal",
    requestWithdrawalDesc: "Enter the amount you want to withdraw and your bank account details",
    accountNumber: "Account Number",
    accountNumberPlaceholder: "IBAN or Account Number",
    accountHolderName: "Account Holder Name",
    accountNamePlaceholder: "Your name as shown on bank account",
    bankName: "Bank Name",
    bankNamePlaceholder: "Your bank name",
    fillAllFields: "Please fill in all required fields",
    insufficientBalance: "Insufficient balance",
    minWithdraw: "Minimum Withdrawal: 50 QAR",
    ...
    referralRewardDesc: "Invite friends and earn 50 QAR per successful referral",
    perReferral: "per Referral",
    bookingReward: "Booking Reward",
    bookingRewardDesc: "Complete a booking and earn 10 QAR",
    perBooking: "per Booking",
    reviewReward: "Review Reward",
    reviewRewardDesc: "Leave a review after your appointment and earn 5 QAR",
    perReview: "per Review",
    totalPoints: "Total Points",
    ourLevel: "Our Level",
    nextLevelIn: "Next Level in",
    coming: "Coming Soon",
    walletComing: "Wallet Features Coming Soon",
    walletComingDesc: "We're working on adding more wallet features including promos, bonus rewards, and more.",
    availablePromos: "Available Promo Codes",
    noPromos: "No Active Promo Codes",
    noPromosDesc: "No active promo codes available at the moment. Check back later for new offers!",
    withdrawalsHistory: "Withdrawals History",
    noWithdrawals: "No Withdrawals Yet",
    noWithdrawalsDesc: "Your withdrawal requests history will appear here",
  },
};
